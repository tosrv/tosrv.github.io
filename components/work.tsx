...
export default function Work() {
  return (
    <section id="work">
      <h2 className="text-3xl font-bold text-center bg-linear-to-l from-primary to-orange-600 dark:to-purple-500 bg-clip-text text-transparent">Work Experience</h2>
